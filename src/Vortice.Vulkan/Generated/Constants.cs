...
public static partial class Vulkan
{
	...
	public const uint VK_HEADER_VERSION = 310;
	...
	public static VkVersion VK_STD_VULKAN_VIDEO_CODEC_AV1_ENCODE_API_VERSION_1_0_0 => new VkVersion(1, 0, 0);
	...
	public const VkHostImageCopyFlags VK_HOST_IMAGE_COPY_MEMCPY = VkHostImageCopyFlags.Memcpy;
	...
	public const VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT_E4M3_NV = VkComponentTypeKHR.FloatE4m3NV;
	public const VkComponentTypeKHR VK_COMPONENT_TYPE_FLOAT_E5M2_NV = VkComponentTypeKHR.FloatE5m2NV;
	...
	public const VkVideoEncodeAV1PredictionModeKHR VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_KHR = VkVideoEncodeAV1PredictionModeKHR.VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_INTRA_ONLY_;
	public const VkVideoEncodeAV1PredictionModeKHR VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_KHR = VkVideoEncodeAV1PredictionModeKHR.VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_SINGLE_REFERENCE_;
	public const VkVideoEncodeAV1PredictionModeKHR VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_KHR = VkVideoEncodeAV1PredictionModeKHR.VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_UNIDIRECTIONAL_COMPOUND_;
	public const VkVideoEncodeAV1PredictionModeKHR VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_KHR = VkVideoEncodeAV1PredictionModeKHR.VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_BIDIRECTIONAL_COMPOUND_;
	public const VkVideoEncodeAV1RateControlGroupKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA_KHR = VkVideoEncodeAV1RateControlGroupKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_INTRA_;
	public const VkVideoEncodeAV1RateControlGroupKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE_KHR = VkVideoEncodeAV1RateControlGroupKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_PREDICTIVE_;
	public const VkVideoEncodeAV1RateControlGroupKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE_KHR = VkVideoEncodeAV1RateControlGroupKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_GROUP_BIPREDICTIVE_;
	public const VkVideoEncodeAV1CapabilityFlagsKHR VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_KHR = VkVideoEncodeAV1CapabilityFlagsKHR.VK_VIDEO_ENCODE_AV1_CAPABILITY_PER_RATE_CONTROL_GROUP_MIN_MAX_Q_INDEX_BIT_;
	public const VkVideoEncodeAV1CapabilityFlagsKHR VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER_BIT_KHR = VkVideoEncodeAV1CapabilityFlagsKHR.VK_VIDEO_ENCODE_AV1_CAPABILITY_GENERATE_OBU_EXTENSION_HEADER_BIT_;
	public const VkVideoEncodeAV1CapabilityFlagsKHR VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY_BIT_KHR = VkVideoEncodeAV1CapabilityFlagsKHR.VK_VIDEO_ENCODE_AV1_CAPABILITY_PRIMARY_REFERENCE_CDF_ONLY_BIT_;
	public const VkVideoEncodeAV1CapabilityFlagsKHR VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_KHR = VkVideoEncodeAV1CapabilityFlagsKHR.VK_VIDEO_ENCODE_AV1_CAPABILITY_FRAME_SIZE_OVERRIDE_BIT_;
	public const VkVideoEncodeAV1CapabilityFlagsKHR VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_KHR = VkVideoEncodeAV1CapabilityFlagsKHR.VK_VIDEO_ENCODE_AV1_CAPABILITY_MOTION_VECTOR_SCALING_BIT_;
	public const VkVideoEncodeAV1StdFlagsKHR VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET_BIT_KHR = VkVideoEncodeAV1StdFlagsKHR.VK_VIDEO_ENCODE_AV1_STD_UNIFORM_TILE_SPACING_FLAG_SET_BIT_;
	public const VkVideoEncodeAV1StdFlagsKHR VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET_BIT_KHR = VkVideoEncodeAV1StdFlagsKHR.VK_VIDEO_ENCODE_AV1_STD_SKIP_MODE_PRESENT_UNSET_BIT_;
	public const VkVideoEncodeAV1StdFlagsKHR VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME_BIT_KHR = VkVideoEncodeAV1StdFlagsKHR.VK_VIDEO_ENCODE_AV1_STD_PRIMARY_REF_FRAME_BIT_;
	public const VkVideoEncodeAV1StdFlagsKHR VK_VIDEO_ENCODE_AV1_STD_DELTA_Q_BIT_KHR = VkVideoEncodeAV1StdFlagsKHR.VK_VIDEO_ENCODE_AV1_STD_DELTA_Q_BIT_;
	public const VkVideoEncodeAV1SuperblockSizeFlagsKHR VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64_BIT_KHR = VkVideoEncodeAV1SuperblockSizeFlagsKHR.VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64_BIT_;
	public const VkVideoEncodeAV1SuperblockSizeFlagsKHR VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128_BIT_KHR = VkVideoEncodeAV1SuperblockSizeFlagsKHR.VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128_BIT_;
	public const VkVideoEncodeAV1RateControlFlagsKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP_BIT_KHR = VkVideoEncodeAV1RateControlFlagsKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REGULAR_GOP_BIT_;
	public const VkVideoEncodeAV1RateControlFlagsKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR = VkVideoEncodeAV1RateControlFlagsKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_;
	public const VkVideoEncodeAV1RateControlFlagsKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR = VkVideoEncodeAV1RateControlFlagsKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_;
	public const VkVideoEncodeAV1RateControlFlagsKHR VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR = VkVideoEncodeAV1RateControlFlagsKHR.VK_VIDEO_ENCODE_AV1_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_;
	...
	public const VkCooperativeVectorMatrixLayoutNV VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_ROW_MAJOR_NV = VkCooperativeVectorMatrixLayoutNV.VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_ROW_MAJOR_;
	public const VkCooperativeVectorMatrixLayoutNV VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_COLUMN_MAJOR_NV = VkCooperativeVectorMatrixLayoutNV.VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_COLUMN_MAJOR_;
	public const VkCooperativeVectorMatrixLayoutNV VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_INFERENCING_OPTIMAL_NV = VkCooperativeVectorMatrixLayoutNV.VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_INFERENCING_OPTIMAL_;
	public const VkCooperativeVectorMatrixLayoutNV VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_TRAINING_OPTIMAL_NV = VkCooperativeVectorMatrixLayoutNV.VK_COOPERATIVE_VECTOR_MATRIX_LAYOUT_TRAINING_OPTIMAL_;
