...
public readonly partial struct MTLDevice_id : IEquatable<MTLDevice_id>
{
	...
	public static bool operator !=(MTLDevice_id left, MTLDevice_id right) => left.Handle != right.Handle;
	public static bool operator ==(MTLDevice_id left, ulong right) => left.Handle == right;
	public static bool operator !=(MTLDevice_id left, ulong right) => left.Handle != right;
	public bool Equals(MTLDevice_id other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is MTLDevice_id handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(MTLDevice_id)} [0x{Handle.ToString("X")}]";
}
...
public readonly partial struct MTLCommandQueue_id : IEquatable<MTLCommandQueue_id>
{
	...
	public static bool operator !=(MTLCommandQueue_id left, MTLCommandQueue_id right) => left.Handle != right.Handle;
	public static bool operator ==(MTLCommandQueue_id left, ulong right) => left.Handle == right;
	public static bool operator !=(MTLCommandQueue_id left, ulong right) => left.Handle != right;
	public bool Equals(MTLCommandQueue_id other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is MTLCommandQueue_id handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(MTLCommandQueue_id)} [0x{Handle.ToString("X")}]";
}
...
public readonly partial struct MTLBuffer_id : IEquatable<MTLBuffer_id>
{
	...
	public static bool operator !=(MTLBuffer_id left, MTLBuffer_id right) => left.Handle != right.Handle;
	public static bool operator ==(MTLBuffer_id left, ulong right) => left.Handle == right;
	public static bool operator !=(MTLBuffer_id left, ulong right) => left.Handle != right;
	public bool Equals(MTLBuffer_id other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is MTLBuffer_id handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(MTLBuffer_id)} [0x{Handle.ToString("X")}]";
}
...
public readonly partial struct MTLTexture_id : IEquatable<MTLTexture_id>
{
	...
	public static bool operator !=(MTLTexture_id left, MTLTexture_id right) => left.Handle != right.Handle;
	public static bool operator ==(MTLTexture_id left, ulong right) => left.Handle == right;
	public static bool operator !=(MTLTexture_id left, ulong right) => left.Handle != right;
	public bool Equals(MTLTexture_id other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is MTLTexture_id handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(MTLTexture_id)} [0x{Handle.ToString("X")}]";
}
...
public readonly partial struct IOSurfaceRef : IEquatable<IOSurfaceRef>
{
	...
	public static bool operator !=(IOSurfaceRef left, IOSurfaceRef right) => left.Handle != right.Handle;
	public static bool operator ==(IOSurfaceRef left, ulong right) => left.Handle == right;
	public static bool operator !=(IOSurfaceRef left, ulong right) => left.Handle != right;
	public bool Equals(IOSurfaceRef other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is IOSurfaceRef handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(IOSurfaceRef)} [0x{Handle.ToString("X")}]";
}
...
public readonly partial struct MTLSharedEvent_id : IEquatable<MTLSharedEvent_id>
{
	...
	public static bool operator !=(MTLSharedEvent_id left, MTLSharedEvent_id right) => left.Handle != right.Handle;
	public static bool operator ==(MTLSharedEvent_id left, ulong right) => left.Handle == right;
	public static bool operator !=(MTLSharedEvent_id left, ulong right) => left.Handle != right;
	public bool Equals(MTLSharedEvent_id other) => Handle == other.Handle;
	/// <inheritdoc/>
	public override bool Equals(object? obj) => obj is MTLSharedEvent_id handle && Equals(handle);
	/// <inheritdoc/>
	public override int GetHashCode() => Handle.GetHashCode();
	private string DebuggerDisplay => $"{nameof(MTLSharedEvent_id)} [0x{Handle.ToString("X")}]";
}
